...
<body>
<h1 class="m-5 text-center">Deposit</h1>
	<form:form method="POST" action="/bankApp/depositProcess">
		<table align="center">
			<tr>
				<td>Deposit Amount</td>
				<td><input type="text" id="depositAmount" class="form-control mr-sm-2 m-1" name="depositAmount"/></td>
			</tr>
			<tr>
				<td>Customer ID</td>
			...
			<tr>
				<td></td>
				<td><input class="btn btn-success mt-3 ml-1 mb-1" type="submit" value="Deposit" /></td>
			</tr>
			<tr>
				<td></td>
