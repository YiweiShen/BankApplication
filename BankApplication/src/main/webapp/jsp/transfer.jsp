	...
	<form:form method="POST" action="/bankApp/transferProcess">
		<table align="center">
			...
			<tr>
				...
				<td><input type="text" class="form-control mr-sm-2 m-1" id="transferAmount" name="transferAmount"/></td>
			</tr>
			<tr>
				<td>Receiving Account No. (Transfer To)</td>
				<td><input type="text" class="form-control mr-sm-2 m-1" id="receivingAcctNo" name="receivingAcctNo"/></td>
			</tr>
			<tr>
				<td></td>
				<td><input class="btn btn-success mt-3 m-1" type="submit" value="Transfer" /></td>
			</tr>
			<tr>
				<td></td>
