...
<body class="d-flex flex-column" style="min-height: 100vh">
	...
	<form:form method="POST" action="/bankApp/paybillProcess">
		<table align="center">
			...
			<tr>
				<td>Biller Name</td>
				<td><form:input path="billerName"
						class="form-control mr-sm-2 m-1" />${billerName}</td>
			</tr>
			<tr>
				<td>Biller Account No.</td>
				<td><form:input path="billerAcctNo"
						class="form-control mr-sm-2 m-1" />${billerAcctNo}</td>
			</tr>
			<tr>
				<td>Bill Amount</td>
			...
			<tr>
				...
				<td><input type="text" id="paymentAcctNo"
					class="form-control mr-sm-2 m-1" name="paymentAcctNo" /></td>
			</tr>
			<tr>
				<td></td>
				<td><input class="btn btn-success mt-3 m-1" type="submit"
					value="Pay this bill" /></td>
			</tr>
			<tr>
				<td></td>
